...
5. 保存
   - パス: skills/{skill-name}/（multi-agent-jin リポジトリ内）
   - 既存スキルと名前が被らないか確認
...
1. 兵がスキル化候補を発見 → 軍師に報告
2. 軍師 → 大将軍に報告
3. **大将軍が最新仕様をリサーチし、スキル設計を行う**
4. 大将軍が本陣に承認を依頼
5. 王が承認
6. 大将軍 → 軍師に作成を指示（設計書付き）
7. **軍師が兵にこの skill-creator を使用してスキルを作成させる**
8. 完了報告

※ 大将軍がリサーチした最新仕様に基づいて作成すること。
※ 大将軍からの設計書に従うこと。
